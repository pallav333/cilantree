            ...
            {[
              ...
              return (
                <motion.div
                  ...
                  className="group bg-[#F5EBDD] p-8 rounded-2xl border border-[#E9D9C2] hover:border-[#CC842F] shadow-sm hover:shadow-xl transition-all duration-500 flex flex-col justify-between"
                >
