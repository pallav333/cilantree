    ...
    <section className="py-24 md:py-32 bg-[#F5EBDD] border-b border-[#E9D9C2]">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          {/* LEFT: Info Card */}
          <div className="lg:col-span-7 bg-[#E9D9C2]/30 p-8 md:p-12 rounded-2xl border border-[#E9D9C2] flex flex-col justify-between space-y-8">
            <div>
          ...
          <div className="lg:col-span-5 bg-[#CE4527] text-[#FAF3E8] p-8 md:p-12 rounded-2xl border border-[#CE4527] flex flex-col justify-between relative overflow-hidden">
