...
export default function StorySection() {
  ...
  return (
    <section ref={sectionRef} className="pt-10 md:pt-16 pb-20 md:pb-28 bg-[#fde9ce] border-b border-[#E9D9C2] overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        {/* Two-Column Editorial Layout */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          {/* LEFT: Section Header + Text Narrative */}
          <div className="lg:col-span-6 space-y-6">
            ...
            <motion.div
              ...
              className="space-y-6 text-[#29251F]/80 leading-relaxed font-light text-base md:text-lg"
            >
          ...
          {/* RIGHT: Taj Mahal Architectural Video + Editorial Interior Photo */}
          <div className="lg:col-span-6 flex flex-col items-center gap-8">
            {/* Taj Mahal Architectural Video */}
            <motion.div
              initial={{ opacity: 0, scale: 0.96 }}
              whileInView={{ opacity: 1, scale: 1 }}
              viewport={{ once: true, amount: 0.2 }}
              transition={{ duration: 0.8, ease: [0.22, 1, 0.36, 1] }}
              className="w-full max-w-[280px] sm:max-w-[320px] md:max-w-[360px] lg:max-w-[380px] self-center select-none"
            >
              <video
                ref={videoRef}
                src="/taj_mahal.mp4"
            ...
            {/* Editorial Image & Floating Glass Badge */}
            <motion.div
              initial={{ opacity: 0, scale: 0.96 }}
              whileInView={{ opacity: 1, scale: 1 }}
              viewport={{ once: true, amount: 0.2 }}
