export const testimonials = [
  ...
  {
    id: 3,
    quote: 'From the warm ivory dining room to the aromatic Dum Biryani served with golden saffron rice, every moment felt like a private royal feast.',
    name: 'Aisha Patel',
    role: 'Executive Director',
    publication: 'Global Culinary Review',
    rating: 5,
    location: 'London, UK',
